...
import { type AuthLogger, toBetterAuthLoggerOption } from "@app/integrations/external/auth";
...
export function createDevAuth(config: AppConfig["auth"], db: Database, logger: AuthLogger) {
  return betterAuth({
