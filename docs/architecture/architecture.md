...
詳細は [api-service の AGENTS.md](../../apps/api-service/AGENTS.md#architecture-api-service) / [client の AGENTS.md](../../apps/client/AGENTS.md#architecture-client) のアーキテクチャ節と [開発ガイド](../dev/development.md) を参照。
